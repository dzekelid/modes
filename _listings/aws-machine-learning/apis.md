...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/apis.md
...
- name: AWS Machine Learning API - Create Evaluation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actioncreateevaluation-get-openapi.md
- name: AWS Machine Learning API - Create M L Model
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actioncreatemlmodel-get-openapi.md
- name: AWS Machine Learning API - Create Realtime Endpoint
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actioncreaterealtimeendpoint-get-openapi.md
- name: AWS Machine Learning API - Delete M L Model
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actiondeletemlmodel-get-openapi.md
- name: AWS Machine Learning API - Delete Realtime Endpoint
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actiondeleterealtimeendpoint-get-openapi.md
- name: AWS Machine Learning API - Describe M L Models
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actiondescribemlmodels-get-openapi.md
- name: AWS Machine Learning API - Get M L Model
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actiongetmlmodel-get-openapi.md
- name: AWS Machine Learning API - Predict
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actionpredict-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actionpredict-get-openapi.md
- name: AWS Machine Learning API - Update M L Model
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modes/master/_listings/aws-machine-learning/actionupdatemlmodel-get-openapi.md
x-common:
- type: x-api-gallery
